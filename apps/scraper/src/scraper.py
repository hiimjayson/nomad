...
class Scraper:
    ...
    def scrape(self, naver_map_url: str) -> CafeData:
        ...
        # 2. 구글 지도 링크 찾기
        google_map_url = self.google_service.find_google_map_url(
            basic_info.name,
            basic_info.full_address
        )

        basic_info.google_map_url = google_map_url
        ...
        basic_info.searched_articles.extend(naver_search_results)
